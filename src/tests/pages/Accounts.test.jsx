...
describe('Accounts', () => {
  ...
  it('renders loading slate and then accounts list', async () => {
    ...
    expect(checkingCells[5]).toHaveTextContent('5')
    expect(within(checkingCells[6]).getByText('INR')).toBeInTheDocument()
    expect(checkingCells[6]).toHaveTextContent('200.00')
    expect(within(checkingCells[7]).getByText('INR')).toBeInTheDocument()
    expect(checkingCells[7]).toHaveTextContent('1,200.00')
    expect(within(checkingCells[8]).getByText('INR')).toBeInTheDocument()
    expect(checkingCells[8]).toHaveTextContent('1,000.00')
    ...
    expect(cardCells[5]).toHaveTextContent('3')
    expect(within(cardCells[6]).getByText('INR')).toBeInTheDocument()
    expect(cardCells[6]).toHaveTextContent('700.00')
    expect(within(cardCells[7]).getByText('INR')).toBeInTheDocument()
    expect(cardCells[7]).toHaveTextContent('200.00')
    expect(within(cardCells[8]).getByText('INR')).toBeInTheDocument()
    expect(cardCells[8]).toHaveTextContent('-500.00')
    expect(
    ...
    expect(totalCells[1]).toHaveTextContent('8')
    expect(within(totalCells[2]).getByText('INR')).toBeInTheDocument()
    expect(totalCells[2]).toHaveTextContent('900.00')
    expect(totalCells[3]).toHaveTextContent('1,400.00')
    expect(within(totalCells[4]).getByText('INR')).toBeInTheDocument()
    expect(totalCells[4]).toHaveTextContent('500.00')
  })
